...
from handlers import start, ask_surname, ask_age, ask_genres, ask_actors, finish, show_recommendations
...
def main():
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            ASK_ACTORS: [MessageHandler(filters.TEXT & ~filters.COMMAND, finish)],
        },
        fallbacks=[],
    )

    application.add_handler(conv_handler)
    application.add_handler(CallbackQueryHandler(show_recommendations))
